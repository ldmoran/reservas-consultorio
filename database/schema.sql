...
-- Insertar servicios de ejemplo con precios
INSERT INTO servicios (nombre_servicio, precio, descripcion, duracion_minutos) VALUES
('Consulta General', 25, 'Consulta médica general', 30),
('Limpieza Dental', 40, 'Limpieza y revisión dental', 45),
('Corte de Cabello', 5, 'Corte de cabello básico', 30),
('Manicure', 10, 'Manicure completo', 45),
('Masaje Relajante', 30, 'Masaje de relajación', 60);
...
-- 4. Cambiado tipo de precio de DECIMAL a INTEGER
