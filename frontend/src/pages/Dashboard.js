                        ...
                        <div className="flex flex-col h-full">
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-3">
                              ...
                              <span className={`px-2 py-1 rounded-full text-xs font-semibold ${servicio.activo
                      ...
                      {usuarios
                        ...
                        .map((usuario, index) => (
                          <div key={usuario.idUsuario} className="flex items-center justify-between p-3 bg-secondary-50 rounded-lg hover:bg-secondary-100 transition-colors">
                            <div className="flex items-center space-x-3">
                              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold ${index === 0 ? 'bg-yellow-500' :
                                  index === 1 ? 'bg-gray-400' :
                              ...
                              <div>
                                ...
                                <div className="flex items-center space-x-2">
                                  <span className={`px-2 py-0.5 rounded text-xs font-medium ${usuario.rol === 'ADMINISTRADOR' ? 'bg-purple-100 text-purple-700' :
                        ...
                        <tbody>
                          {usuarios.map((usuario) => (
                            <tr key={usuario.idUsuario} className="border-b border-secondary-100 hover:bg-secondary-50 transition-colors">
                              ...
                              <td className="py-4 px-4">
                                <span className={`px-3 py-1 rounded-full text-sm font-semibold ${usuario.rol === 'ADMINISTRADOR' ? 'bg-purple-100 text-purple-800' :
                        ...
                        <div key={usuario.idUsuario} className="p-4 bg-secondary-50 rounded-xl">
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              ...
                              <span className={`px-2 py-1 rounded-full text-xs font-semibold ${usuario.rol === 'ADMINISTRADOR' ? 'bg-purple-100 text-purple-800' :
                                  usuario.rol === 'SUPERVISOR' ? 'bg-blue-100 text-blue-800' :
                                    usuario.rol === 'EMPLEADO' ? 'bg-green-100 text-green-800' :
                                      'bg-secondary-100 text-secondary-800'
                                }`}>
                          ...
                          <div className="flex items-center justify-between mt-3 pt-3 border-t border-secondary-200">
                            <span className={`px-2 py-1 rounded-full text-xs font-semibold ${usuario.activo
                                ? 'bg-success-100 text-success-800'
                                : 'bg-error-100 text-error-800'
                              }`}>
                              {usuario.activo ? 'Activo' : 'Inactivo'}
              ...
              <div className="border-b border-secondary-200">
                <nav className="flex space-x-8">
                  ...
                  <button
                    ...
                    className={`py-2 px-1 border-b-2 font-medium text-sm ${activeConfigTab === 'roles'
                        ? 'border-primary-500 text-primary-600'
                        : 'border-transparent text-secondary-500 hover:text-secondary-700 hover:border-secondary-300'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`py-2 px-1 border-b-2 font-medium text-sm ${activeConfigTab === 'perfil'
                        ? 'border-primary-500 text-primary-600'
                        : 'border-transparent text-secondary-500 hover:text-secondary-700 hover:border-secondary-300'
                      }`}
                  >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {Object.keys(rolePermissions).map((role) => (
                      <div key={role} className="card-elevated">
                        <div className="flex items-center mb-4">
                          <div className={`w-3 h-3 rounded-full mr-3 ${role === 'ADMINISTRADOR' ? 'bg-purple-500' :
                        ...
                        <div className="space-y-3">
                          {AVAILABLE_MODULES.map((module) => {
                            ...
                            return (
                              <div key={module.id} className={`p-3 rounded-lg ${isDisabled ? 'bg-red-50 border border-red-200' : 'bg-secondary-50'
                                }`}>
                                ...
                                <div className="hidden md:flex items-center justify-between">
                                  ...
                                  <label className={`relative inline-flex items-center ${isDisabled ? 'cursor-not-allowed' : 'cursor-pointer'}`}>
                                    ...
                                    />
                                    <div className={`w-9 h-5 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all ${isDisabled
